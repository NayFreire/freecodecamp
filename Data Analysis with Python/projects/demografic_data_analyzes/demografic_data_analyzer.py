...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = df[df['salary'] == '>50K']['native-country'].unique()[0]
    highest_earning_country_percentage = (len(df[df['native-country'] == highest_earning_country]) / len(df)) * 100
